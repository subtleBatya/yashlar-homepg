...
function YashlarBarada() {
    return (
        ...
        <div className="w-1/2 mx-auto">
          <div className="text-3xl font-bold mb-12">Wakansiyalar</div>
          <div className=' flex flex-col font-semibold cursor-pointer gap-3'>
          <NavLink to={`/vacancy/about`}>
              <div className='bg-[#fafafa] px-5 py-3 flex flex-col tracking-wide gap-2'>
                <div>Yas Telekeciler Gozlenilyar</div>
                <div className="textGray text-sm">16.03.2024</div>
              </div>
          </NavLink>
          <NavLink to={`/vacancy/about`}>
              <div className='bg-[#fafafa] px-5 py-3 flex flex-col tracking-wide gap-2'>
